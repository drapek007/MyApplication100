...
public class Activity33 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        datababaseTraining = FirebaseDatabase.getInstance().getReference("Badmintonmaniaa");
    ...
    protected void onStart() {
        ...
        datababaseTraining.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                TrainingList adapter = new TrainingList(Activity33.this, trainingList);
    ...
    private void showUpdateDialog2(String name, String place, String date, int time, int quantity, String id){
        ...
        dialogBuilder.setView(dialogView);
        datababaseTraining2 = FirebaseDatabase.getInstance().getReference("Badmintonmania");
    ...
    private void updateTraining(int quantity, String id){
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("Badmintonmaniaa");
    ...
    private void createListUserTraining(String date, String name, String place, int time, String id, String parentname){
        ...
        databaseReference2 = FirebaseDatabase.getInstance().getReference("Badmintonmania");
