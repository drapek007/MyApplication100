...
public class Activity66 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        datababaseTraining = FirebaseDatabase.getInstance().getReference("PaczekBadminton");
    ...
    protected void onStart() {
        ...
        datababaseTraining.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                TrainingList adapter = new TrainingList(Activity66.this, trainingList);
...
*/
    ...
    private void updateTraining( int quantity, String id){
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("PaczekBadminton");
