...
public class Activity12 extends AppCompatActivity implements View.OnClickListener{
    ...
    private String userID, usermail, name2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        datababaseTraining = FirebaseDatabase.getInstance().getReference("AkademiaBadmintonaa");
    ...
    private void showUpdateDialog2(String name, String place, String date, int time, int quantity, String id){
        ...
        dialogBuilder.setView(dialogView);
        datababaseTraining2 = FirebaseDatabase.getInstance().getReference("AkademiaBadmintona");
        datababaseTraining2.child(id).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot zapisSnapshot : dataSnapshot.getChildren()){
                    ...
                    //System.out.println("kupa + " + user3.getName());
                    System.out.println("dziecko "+ user3.name);
                ...
                try{
                    textView2.setText(user3.name);
                    //textView3.setText(zapisyList.get(2).getName());
                  //  textView4.setText(zapisyList.get(3).getName());
                //    textView5.setText(zapisyList.get(4).getName());
              //      textView6.setText(zapisyList.get(5).getName());
            //        textView7.setText(zapisyList.get(6).name());
    ...
    private void updateTraining(int quantity, String id){
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("AkademiaBadmintonaa");
    ...
    private void createListUserTraining(String date, String name, String place, int time, String id, String parentname){
        ...
        System.out.println("pyszczek " + id);
        System.out.println("pyszczek " + user.getUid());
        System.out.println("pyszczek " + name2);


        /////////////////////////////////////////////////////////////////////////////////////
        // W tym momencie tworze wpis kolejnej listy

        databaseReference2 = FirebaseDatabase.getInstance().getReference("AkademiaBadmintona");
        databaseReference2.child(id).child(user.getUid()).child("name").setValue(name2);
